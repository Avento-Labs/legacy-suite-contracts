...
async function main() {
  ...
  try {
    const [admin, authorizer, owner, wallet1, wallet2, wallet3, _] = await ethers.getSigners();
    ...
    const LegacyAssetManager = await (await LegacyAssetManagerFactory.deploy(3)).deployed();
